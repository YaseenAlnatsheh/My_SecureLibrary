<?php
// Library/public/admin/login.php
        ...
        if ($error === '') {
            if (!v_email($email)) {
                ...
                if (!$admin || (int)$admin['is_active'] !== 1) {
                    ...
                    $otp = mfa_generate_otp('admin', 300);
                    $_SESSION['pending_admin_otp_debug'] = $otp;

                    audit_log('admin', (int)$admin['id'], 'MFA_OTP_SENT', 'Admin OTP generated (demo)');

                    redirect('/admin/verify_otp.php');
                }
            }
        }
    }
...
<body>
  <div class="container">
    ...
    <p class="muted"><a href="../login.php">Back to User Login</a></p>
  </div>
</body>
</html>
